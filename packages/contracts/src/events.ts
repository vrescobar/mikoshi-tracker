...
/**
 * One row in the EventMutation audit trail. previousPayload and nextPayload are
 * JSON objects (or null) — their per-type structure is not validated statically.
 */
...
/**
 * An EntryEvent record. payload is a JSON object validated dynamically against
 * EntryType.payloadSchema — not statically typed here.
 */
...
export type EventMutationType = z.infer<typeof eventMutationTypeSchema>;
export type EventSource = z.infer<typeof eventSourceSchema>;
export type EventMutationRecord = z.infer<typeof eventMutationRecordSchema>;
export type EntryEventRecord = z.infer<typeof entryEventRecordSchema>;
export type EntryEventDetail = z.infer<typeof entryEventDetailSchema>;
