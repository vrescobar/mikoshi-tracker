...
/**
 * Compat primitives for the ported admin views (from the retired admin SPA's
 * components/ui.tsx). The class names are styled by ./admin.css on the shared
 * design tokens.
 */
...
export function Modal({
  ...
  return (
    <div className="admin-scope-overlay center" onMouseDown={onClose}>
...
export function Drawer({
  ...
  return (
    <div className="admin-scope-overlay right" onMouseDown={onClose}>
