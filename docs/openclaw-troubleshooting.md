...
| Startup says the token looks like an email or URL                                                                 | The wrong secret shape was injected                                                                                     | Keep the API URL in `MIKOSHI_TRACKER_API_URL` and inject a personal API token into `MIKOSHI_TRACKER_API_TOKEN`.                                                                                                       |
