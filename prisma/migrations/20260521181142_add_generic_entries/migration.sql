...
-- Seed built-in EntryTypes (INSERT OR IGNORE so re-applying is safe)
INSERT OR IGNORE INTO "EntryType" ("id","slug","displayName","cadence","payloadSchema","configSchema","aggregations","skillSlug","isBuiltIn","isActive","createdAt","updatedAt") VALUES
  ...
  ('builtin_food_meal_00000001','food_meal','entry_type.food_meal','event_log','{"type":"object","required":["name","kcal","protein_g","carbs_g","fat_g","source","confidence"],"properties":{"name":{"type":"string","minLength":1},"kcal":{"type":"number","minimum":0},"protein_g":{"type":"number","minimum":0},"carbs_g":{"type":"number","minimum":0},"fat_g":{"type":"number","minimum":0},"fiber_g":{"type":"number","minimum":0,"nullable":true},"sugar_g":{"type":"number","minimum":0,"nullable":true},"portion_g":{"type":"number","minimum":0,"nullable":true},"mealSlot":{"type":"string","enum":["breakfast","lunch","snack","dinner","other"],"nullable":true},"source":{"type":"string","enum":["label","similar_to_event","web_lookup","vision_only","manual"]},"confidence":{"type":"number","minimum":0,"maximum":1},"similarToEventId":{"type":"string","nullable":true},"sources":{"type":"array","items":{"type":"string"},"nullable":true},"notes":{"type":"string","nullable":true}},"additionalProperties":false}','{"type":"object","properties":{},"additionalProperties":false}','{"metrics":["sum","count","missing_days"],"sumFields":["kcal","protein_g","carbs_g","fat_g"]}','mikoshi-tracker-food',1,1,'2026-05-21T00:00:00.000Z','2026-05-21T00:00:00.000Z');
